...
function chee_enqueue_custom_fonts() {
	...
	// wp_enqueue_style('google', "https://fonts.googleapis.com/css2?family=Abril+Fatface&family=Lato:wght@400;700&display=swap", array(), null); NOTE: Google Fonts require additional arguments, as listed here
}
